...
- 比邻环：右上角加号可建立文件夹，支持家庭、友谊、爱情和其他自定义相册；可选择是否开启个人三色环 social，关闭时保留原有相册功能，开启后可选择照片形成三色环，并通过预留智能体接口生成三环建议；相册卡片右上角 VR 小图标可将相册剪辑成回忆视频，并立即弹出播放层。
...
回忆和 NFC 不再作为底部 tab 出现。回忆视频不保留固定区域，点击比邻环相册的 VR 图标后即时生成并播放，片段之间使用平滑过渡；打开任意比邻环相册后，详情页右上角的 NFC 图标可选择“仅用 NFC 分享该相册内容”，或“变成多人相册”。
...
- 三色环智能体预留接口：`/agents/personal-tri-ring/social`
- Hive
- image_picker
- photo_manager
- nfc_manager
