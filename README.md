...
- 比邻环：右上角加号可建立文件夹，支持家庭、友谊、爱情和其他自定义相册；可选择是否开启个人三色环 social，关闭时保留原有相册功能，开启后可为每个环选择 3-10 张照片，并通过预留智能体接口进行图片分析、后台用户画像和匹配系统推荐；相册卡片右上角 AR 图标可生成同场景重现，VR 小图标可将相册剪辑成回忆视频，并立即弹出播放层。
