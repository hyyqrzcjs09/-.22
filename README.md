...
- 回忆：展示由相册剪辑生成的视频速览，片段之间使用平滑过渡。
- 分类：右上角加号可建立文件夹，支持家庭、友谊、爱情和其他自定义相册；相册卡片右上角 VR 小图标可将相册剪辑成回忆视频。

NFC 不再作为底部 tab 出现。打开任意分类相册后，详情页右上角的 NFC 图标可选择“仅用 NFC 分享该相册内容”，或“变成多人相册”。
